<?php
	$adresa="246 EAST JANATA BLVD SUITE 130 LOMBARD, ILLINOIS 60148"; //jako je vazno navesti dobro adresu radi boljeg poziciniranja
	$grad="";//jako je vazno ako adresa ima dva imena povezati ih sa plus
	$skracenica=""; // AKo ne znate skracenicu ostavite praznu
	$telephone=6309322055;// Broj koji se poziva na dugme CALL US
